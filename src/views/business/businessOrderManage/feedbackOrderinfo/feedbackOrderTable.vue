...
import control from './component/control.vue'//控制器
import searchText from '../../components/Tables/defFilter/searchText.vue'//传组件
import { searchdata, dofilter, cities, createTableDataByRandom } from './mock.js'
